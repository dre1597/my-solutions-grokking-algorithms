...
describe('Binary Search', () => {
  test('should return null if the list is empty', () => {
    const result = binarySearch(emptyList, 1);
    expect(result).toBe(null);
  });

  test('should return null if the element is not on the list', () => {
    const result1 = binarySearch(numbersList, 0);
    const result2 = binarySearch(charsList, 'z');
  ...
  test('should return the index of the element if its on the list', () => {
    const result1 = binarySearch(numbersList, 1);
    const result2 = binarySearch(numbersList, 5);
    const result3 = binarySearch(numbersList, 3);
    const result4 = binarySearch(charsList, 'a');
    const result5 = binarySearch(charsList, 'e');
    const result6 = binarySearch(charsList, 'c');
